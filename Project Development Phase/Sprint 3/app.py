...
app = Flask(__name__)
model = pickle.load(open('C:/Users/User/Downloads/IBM project/Flask/Phishing_Website.pkl','rb'))

@app.route('/')
def home():
    return render_template('C:/Users/User/Downloads/IBM project/Flask/index.html')
...
def y_predict():
    ...
    if(output==1):
        ...
        return render_template('C:/Users/User/Downloads/IBM project/Flask/index.html',bns=pred)
    
    else:
        pred="You are on the wrong site. Be cautious!"        
        return render_template('C:/Users/User/Downloads/IBM project/Flask/index.html',ans=pred)
